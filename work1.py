...
# Create a script that takes a user's name and age as input and prints a message telling them
...
# # print(name)
# # print(age)
# print(f"hi {name}, you will turn 100 in the year of {year_at_100}")
